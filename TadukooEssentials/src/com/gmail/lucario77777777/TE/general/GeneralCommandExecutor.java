...
public class GeneralCommandExecutor{
	...
	public static boolean Run(CommandSender sender, Command cmd, String[] args, String playerType, TE plugin){
		if(plugin.getCommandsConfig().getString("com/gmail/lucario77777777/TE/general") == "true"){
			...
			return true;
		}else if(plugin.getCommandsConfig().getString("com/gmail/lucario77777777/TE/general") == "false"){
			Disabled("com/gmail/lucario77777777/TE/general", sender);
			return true;
		}else{
			Error("com/gmail/lucario77777777/TE/general", sender, plugin);
			return true;
		}
	}
